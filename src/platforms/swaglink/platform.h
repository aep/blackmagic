...
#define SWAG_SPI SPI1
#define SWAG_SPI_IRQ NVIC_SPI1_IRQ
#define SWAG_SPI_ISR spi1_isr
#define SWAG_SPI_CLK RCC_SPI1
#define SWAG_SPI_CLK_PORT GPIOA
#define SWAG_SPI_CLK_PIN  GPIO5
#define SWAG_SPI_DIO_PORT GPIOA
#define SWAG_SPI_DIO_PIN  GPIO7
